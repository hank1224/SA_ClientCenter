...
class LineAPI_record(models.Model):
    Rstate= models.CharField(max_length=36, blank=False, null=True, verbose_name="網址state辨識碼(用以二次請求)")
    RstateUsed=models.BooleanField(default=False, verbose_name="請求UserID與否(第二次握手)") #指二次握手使用過嗎？
    RlineID=models.CharField(max_length=33, blank=False, null=True, verbose_name="line伺服器回傳的lineID")
