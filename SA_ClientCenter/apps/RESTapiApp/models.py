...
class LineAPI_record(models.Model):
    ...
    Rbackurl=models.CharField(max_length=200, blank=False, null=True, verbose_name="用戶要求line後返回的絕對網址")
...
class SMSAPI_record(models.Model):
    RSMSid= models.CharField(max_length= 42, primary_key=True, verbose_name="要求辨識碼(用以二次請求)")
    ...
    Rphone=models.CharField(max_length=10, blank=False, null=True)
    RSMS_code=models.CharField(max_length=4, null=True ,verbose_name="該次簡訊驗證碼")
