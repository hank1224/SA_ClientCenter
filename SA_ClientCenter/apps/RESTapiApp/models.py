...
class LineAPI_record(models.Model):
    ...
    RstateUsed=models.BooleanField(default=False, verbose_name="用以請求UserID與否(第二次握手)") #指二次握手使用過嗎？
    ...
    Rbackurl=models.CharField(max_length=200, blank=True, null=True, verbose_name="用戶要求line後返回的絕對網址")
